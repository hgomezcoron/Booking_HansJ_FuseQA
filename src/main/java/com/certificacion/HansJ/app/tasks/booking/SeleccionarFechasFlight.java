...
public class SeleccionarFechasFlight implements Task {
    private final String checkInDate;
    private final String checkOutDate;

    public SeleccionarFechasFlight(String checkInDate, String checkOutDate) {
        this.checkInDate = checkInDate;
        this.checkOutDate = checkOutDate;
    }

    public static SeleccionarFechasFlight con(String checkInDate, String checkOutDate) {
        return instrumented(SeleccionarFechasFlight.class, checkInDate, checkOutDate);
    }
